        ...
        children: [
          {
            ...
            children: [
              ...
              { id: 'f-layout', name: 'layout.tsx', type: 'file', extension: 'tsx', size: '0.8 KB' },
              { id: 'f-dashboard', name: 'dashboard/page.tsx', type: 'file', extension: 'tsx', size: '1.4 KB' },
            ],
          },
          { id: 'f-web-json', name: 'package.json', type: 'file', extension: 'json', size: '1.8 KB' },
        ],
      },
      {
        id: 'f-api',
        ...
        children: [
          ...
          { id: 'f-api-module', name: 'src/app.module.ts', type: 'file', extension: 'ts', size: '2.4 KB' },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        type: 'folder',
        children: [
          { id: 'f-physics', name: 'physics/forceSimulation.ts', type: 'file', extension: 'ts', size: '4.8 KB' },
          { id: 'f-scene', name: 'render/SceneBuilder.tsx', type: 'file', extension: 'tsx', size: '6.2 KB' },
          { id: 'f-canvas', name: 'render/UniverseCanvas.tsx', type: 'file', extension: 'tsx', size: '3.5 KB' },
        ],
      },
    ],
  },
